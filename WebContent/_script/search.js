...
//Calls search when user clicks the button
 ...
 function getSearchedUser(value) {
     $.post("HomepageServlet", $.param(value), function(responseText) {
 ...
 $(document).ready(function() {
     $("#friendsList").html(" <em> You are currently accessing the site as a guest. To add friends or find friends, please log in. </em>");
 });